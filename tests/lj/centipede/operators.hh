...
#include <lj/centipede/defs.hh>

template<lj::centipede::DeviceType device>
struct Plus12Int {
  static void Op(void *result, const void *input);
  static lj::centipede::UnaryFunc GetPointer();
};
